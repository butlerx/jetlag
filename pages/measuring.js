    ...
    return html`
      <div class="game-page">
        ...
        <div class="category">
          ...
          <persistent-input id="measuring.airport">✈️ A Commercial Airport</persistent-input>
        ...
        <div class="category">
          ...
          <persistent-input id="measuring.admin-div-1"
            >🗺️ A 1st Admin. Div. Border</persistent-input
          >
          <persistent-input id="measuring.admin-div-2"
            >📍 A 2nd Admin. Div. Border</persistent-input
          >
        </div>
        ...
        <div class="category">
          ...
          <persistent-input id="measuring.coastline">🏖️ A Coastline</persistent-input>
          <persistent-input id="measuring.mountain">⛰️ A Mountain</persistent-input>
        ...
        <div class="category">
          ...
          <persistent-input id="measuring.museum">🏛️ A Museum</persistent-input>
        ...
        <div class="category">
          ...
          <persistent-input id="measuring.consulate">🏛️🌍 A Foreign Consulate</persistent-input>
        </div>
      </div>
    `;
  }
